...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Aguascalientes/Aguascalientes")
write.dbf(ConcAguascalientes,file="ConcAguascalientes2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Aguascalientes/Aguascalientes")
write.dbf(ConcAguascalientes,file="ConcAguascalientes2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Aguascalientes/Aguascalientes")
Conc2010<-read.dbf("ConcAguascalientes2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Aguascalientes por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Aguascalientes INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Aguascalientes NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Aguascalientes/Aguascalientes")
Conc2018<-read.dbf("ConcAguascalientes2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Aguascalientes Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Aguascalientes INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Aguascalientes NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Aguascalientes NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Aguascalientes NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Aguascalientes NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Aguascalientes NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Aguascalientes por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Aguascalientes Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Aguascalientes NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Aguascalientes NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Aguascalientes INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Aguascalientes INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
